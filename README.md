...
<p align="center">
<img src="assets/actual_vs_predicted.png" width="40%">
...
მოდელის შეფასებისთვის აქტიურად ვიყენებდი RMSLE-ს, რითაც ფასდებოდა ჩემი score competition-ზე.

ასევე აქტიურად გამოვიყენე MAE-მეტრიკა რომელიც გვეუბნება საშუალოდ რამდენად ცდება მოდელი რეალურ ფასს. საუკეთესო მოდელმა მიაღწია დაახლოებით 14 000$იან ცდომილებას რაც სახლის ფასებისთვის , ვფიქრობ საკმაოდ სოლიდურია. 

ასევე ვიყენებდი MAPE მეტრიკასაც ,ჩემს ლოგებში საუკეთესო მაჩვენებელია დაახლ. 8.5% რაც ნიშნავს რომ მოდელი 90%+ სიზუსტისაა.

## Final Score

<p align="center">
<img src="assets/FinalScore.png" width="40%">
...
MLflow ზე ვცდილობდი ყველა ნაბიჯი დამელოგა, შესაბამისი ,მარტივად მისახვედრი სახელებით. 
